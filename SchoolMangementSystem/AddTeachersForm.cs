            ...
            else
            {
                if (connect.State != ConnectionState.Open)
                {
                    try
                    {
                        ...
                        string checkTeacherID = "SELECT COUNT(*) FROM Teachers WHERE TeacherID = @teacherID";
                        ...
                        using (SqlCommand checkTID = new SqlCommand(checkTeacherID, connect))
                        {
                            ...
                            else
                            {
                                ...
                                string insertData = "INSERT INTO Teachers (TeacherID, TeacherName, TeacherGender, TeacherAddress, TeacherImage, TeacherStatus, DateInsert) " +
                ...
                if (connect.State != ConnectionState.Open)
                {
                    try
                    {
                        ...
                        if (check == DialogResult.Yes)
                        {
                            ...
                            String updateData = "UPDATE Teachers SET TeacherName = @teacherName, TeacherGender = @teacherGender, TeacherAddress = @teacherAddress, " +
                                     "TeacherStatus = @teacherStatus, DateInsert = @dateUpdate WHERE TeacherID = @teacherID";
                ...
                if (connect.State != ConnectionState.Open)
                {
                    ...
                    if (check == DialogResult.Yes)
                    {
                        ...
                        try
                        {
                            ...
                            string deleteData = "UPDATE Teachers SET DateDelete = @dateDelete WHERE TeacherID = @teacherID";
